...
## Online Resources
  ...
  * [EdRepublic](http://edrepublic.com) (problems by companies and focus area)
  ...
  * [Plunker](https://plnkr.co/) (helping developers make the web)
  ...
  * find largest/smallest
    - standard query in the book
      ...
      SELECT * FROM employee
       ...
       ORDER BY department;
      ```
    - using `WITH` ([analytic and window functions](https://www.postgresql.org/docs/9.5/static/functions-window.html))
