...
import (
	...
	ma "github.com/dockerian/shuati/ds/math"
...
func TestLinkedListNumbers(t *testing.T) {
	...
	for index, test := range tests {
		...
		var sum = ln1.Add(ln2)
		var st1 = ln1.ToString()
		var st2 = ln2.ToString()
